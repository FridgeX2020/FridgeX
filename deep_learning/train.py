...
image_data_train = ImageFolder("./FruitX/trainset",transform=transforms_train)
image_data_test = ImageFolder("./FruitX/testset",transform=transforms_train)
...
# to batch
train_loader = DataLoader(dataset=image_data_train, batch_size=bsz, shuffle=1)
